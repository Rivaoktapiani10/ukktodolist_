...
<body class="glassmorphism">
    ...
    <i class="bi bi-arrow-right-square"></i><a href="logout.php">Logout</a></button>
        ...
        <div class="card table-glassmorphism">
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Tugas </button>
                </form>
            </div>
        </div>
